...
function App() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-lightGrey">
      <div className="absolute top-[10%] left-1/2 -translate-x-1/2 px-6 md:px-16 py-8 mx-auto bg-white rounded-br-[60px] md:rounded-br-[120px] rounded-2xl shadow-xl max-w-fit">
        ...
        <div className="italic font-extrabold text-6xl">
